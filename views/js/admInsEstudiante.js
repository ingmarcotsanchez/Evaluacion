    ...
    this.parseExcel = function(file) {
        ...
        reader.onload = function(e) {
            ...
            workbook.SheetNames.forEach(function(sheetName) {
                ...
                PregInsEstList = JSON.parse(json_object);

                console.log(PregInsEstList)
                for (i = 0; i < PregInsEstList.length; i++) {

                    var columns = Object.values(PregInsEstList[i])

                    $.post("/Evaluacion/controller/insEstudiante.php?opc=guardar_desde_excel",{
                        pei_pregunta : columns[0],
                        estado : columns[1]
                    }, function (data) {
                        console.log(data);
                    });
