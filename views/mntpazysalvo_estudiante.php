...
require_once("../models/Autoevaluacion.php");
    ...
    $aut = $autoevaluacion->realizadas($usu_id);
    //$aut = $autoevaluacion->realizadas($_SESSION["usu_id"]);
    //print_r($aut);
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php if($usu_id == $ins[1]["usu_id"]): ?>
                                    <!-- falta validad que realizo la evaluacion institucional y la autoevaluación de cada asignatura -->
                                    <?php if($aut == NULL):?>
                                        <div class="alert alert-warning">No ha realizado la Autoevaluación</div>
                                    <?php else: ?>
                                        <?php if($usu_id == $aut[1]["usu_id"]): ?>
                                            <p>Estimado estudiante <b><?php echo $_SESSION["usu_nombre"]." ".$_SESSION["usu_apellidos"] ;?></b> gracias por realizar la evaluación institucional y autoevaluar cada una de las asignaturas matriculadas en este semestre, por favor descargar el paz y salvo para entregar en la unidad correspondiente.</p>
