...
<head>
  ...
  ?>
  <title>EAL | Respuestas Autoevaluación</title>
</head>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Admón Respuestas Autoevaluación</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="respEvaEst_data" class="table table-border display responsive wrap">
                                <thead>
                                    <tr>
                                        <th>Pregunta</th>
                                        <th>Respuesta</th>
